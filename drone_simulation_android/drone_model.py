...
class Drone():
    ...
    def update_motor_sliders(self):
        for motor_index in range(len(self.motor_power_per)):
            self.motor_sliders[motor_index].set_value(
                self.motor_power_per[motor_index]
            )
